...
const ADDON_PRICE_TABLE: Record<number, number> = {
  199: 173,
  // Раніше тут був "299: 275" — залишок від старої ціни допуслуги
  // (Quarterly Audit), яку перейменували й здешевили до $49/міс
  // (monthly_digest, див. pricing-section.tsx). Ключ 299 більше нічому
  // не відповідав, тож $49 конвертувався по загальному курсу замість
  // заданого вручну значення — див. п.21 аудиту.
  49: 42,
  29: 25,
};
