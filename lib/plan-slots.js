...
// FIX (тарифы 2026-09-05): сетка расширена под 8 интеграций — было
// Starter=1/Growth=2/Scale=все 8, стало Starter=2/Growth=4/Scale=все 8.
// Обязательное условие "минимум один платёжный/учётный источник в
// непустом выборе" (см. REVENUE_SOURCE_PROVIDERS ниже) не изменилось —
// раньше это неформально описывалось как "Stripe или Shopify", теперь
// формулировка шире ("платёжная система, неважно какая"), потому что
// список подходящих источников тот же самый (stripe/shopify/woocommerce/
// paypal/mollie/quickbooks), просто их теперь 6, а не 2.
...
export const REVENUE_SOURCE_PROVIDERS = ["stripe", "shopify", "woocommerce", "paypal", "mollie", "quickbooks"];
