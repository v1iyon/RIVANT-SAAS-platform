...
// paypal доданий 03.09.2026: на відміну від Shopify (яка може бути ЄДИНИМ
// джерелом виручки — "replace" режим), PayPal тут завжди додатковий канал
// (сам revenue-запис в paypal-sync.mjs завжди "add" на існуючий рядок
// metrics_computed) — але й соло (без Stripe/Shopify) він коректно формує
// власний рядок виручки з нуля, тому як мінімальне джерело для слота теж
// підходить. Не забути додати "paypal" і в локальну копію цього списку в
...
export const REVENUE_SOURCE_PROVIDERS = ["stripe", "shopify", "paypal"];
