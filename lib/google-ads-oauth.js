...
async function listAccessibleCustomers(accessToken) {
  ...
  // ВРЕМЕННАЯ диагностика — уберём после того как найдём причину.
  console.log("gads-debug: accessToken present:", !!accessToken, "length:", accessToken?.length);
  console.log("gads-debug: developerToken present:", !!developerToken, "length:", developerToken?.length, "raw:", JSON.stringify(developerToken));
  ...
  console.log("gads-debug: response status:", res.status, "body:", JSON.stringify(data));
  if (!res.ok) {
