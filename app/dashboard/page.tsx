  ...
  return (
    <div className={`bg-gradient-to-br ${color}/10 to-transparent rounded-xl p-4 border ${color}/20`}>
      <div className="flex items-center justify-between mb-2">
        <div className={`w-7 h-7 rounded-lg ${color}/20 flex items-center justify-center`}>
          <Icon className={`w-3.5 h-3.5 ${color.replace("bg-", "text-")}`} />
        </div>
        <div className={`flex items-center gap-0.5 text-xs px-2 py-0.5 rounded-full ${isPositive ? "bg-green-500/10 text-green-500" : "bg-red-500/10 text-red-500"}`}>
      ...
      <div className="flex items-end justify-between gap-2">
        <div>
          <div className="text-xl font-bold text-white">{prefix}{displayValue}{suffix}</div>
