...
export default function Home() {
  ...
  // FIX 2: 88px відступу на десктопі виявився завеликим — блок зупинявся
  // занадто високо і кнопка "Надіслати запит" внизу картки вже не влазила
  // у видиму область. Зменшено до 28px (лише невеликий "дихальний" відступ
  // під прозорим навбаром) — картка тепер влазить повністю. Мобільний
  // відступ (72px, під фіксованим непрозорим хедером) не чіпаємо.
  const handleOpenCalculator = () => {
    const el = calculatorRef.current;
    if (!el) return;
    const offset = window.innerWidth < 1024 ? 72 : 28;
