...
export async function POST(req) {
  try {
    ...
    if (!provider || provider === "quickbooks") {
      jobs.push(import("../../../scripts/quickbooks-sync.mjs").then((m) => m.runSync(businessId)));
    }
    ...
    const attemptedProviders = provider ? [provider] : ["stripe", "shopify", "woocommerce", "paypal", "mollie", "quickbooks", "meta_ads", "google_ads"];
