...
export async function GET(req) {
  ...
  try {
    ...
    const [stripe, shopify, woocommerce, metaAds, googleAds, paypal, mollie, quickbooks, dailyReports] = await Promise.allSettled([
      ...
      import("../../../../scripts/mollie-sync.mjs").then(({ runSync }) => runSync()),
      import("../../../../scripts/quickbooks-sync.mjs").then(({ runSync }) => runSync()),
      import("../../../../scripts/daily-reports.mjs").then(({ runDailyReports }) => runDailyReports()),
    ]);
    const results = { stripe, shopify, woocommerce, metaAds, googleAds, paypal, mollie, quickbooks, dailyReports };
